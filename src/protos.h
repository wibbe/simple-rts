...
// platform
extern char * resourcepath(const char * file);
extern void messagebox(const char * title, const char * message);
...
extern void cleangl();
extern void gl_drawframe(int w, int h, int mouse_x, int mouse_y, float curfps);
...
// main
extern void fatal(const char * s, const char * o = 0);
...
extern void gl_drawhud(int w, int h, int mouse_x, int mouse_y, int curfps, int nquads, int curvert, bool underwater);
